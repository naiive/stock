...
AUTHORIZATION_TOKEN = "Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6InVzZXIiLCJ0eXAiOiJKV1QifQ..Wv_uMrvEctav6dl_jfwcZh2yL3UQN0wJG93J3SZ5tKeVR8oflX2yeqfq8ZvUx2V5OEtxVpkcUay2CfpDcDpbCbXy3ta1Al5DTp4KOdJ0WQoVzNAa6uXq93CYQLxTrYwcVX8-vc8RIVUPOJde9MmsguOF2zCrNFhdW4PHRQlBYmqLojKO_bzJz9FlWeUVNVvGyhAdHPM9MXJGPeRv9UxT8YVFMqBt4c5tDieRnce4xIcgbEFusEMyZild1JIII6420oyj9gn6Zu1pzra9GhaJIPUomoUf57wx5HgV4GWlS0SE37oF4lUzcx4vYUmZoC6Xx60JidUOj3wmUmcFuRwZGY95o_-uAEMAFENdV0eylgTbsZyChtV61EWXFw3-CyqlDZ2AVEOByoLjOe8NrRFDAkb3FXI-i0FsR7Peam90rhlVdtBFHJQln5SfCL5KALeV4OfXq6Imax_NVfkSP5PD80ht4F7XTxXW3yI_5SnXIsjucpy7M_0bh87YYkhbtzEJwFiTkjKZxslBCxZ2BswMLEt9bwnclVO7KUjzd7ag5KW-aj6PeuUx7cUEok5KWGsTLT9TIy0JufSHwPYUSiX4v06qoTtGwHytLvrTWPoYspp1-qgHcLZcMLWGDe2DbkThujYFnIFfgtSwi6jyRmR-AlMrbQOnqvyfyYymuKJliDs"
...
async def main():
    with gr.Blocks(title="Exness Bot") as bot:
        gr.Markdown("# 🤖 机器人后台运行中")
        gr.Markdown("请查看 ModelScope 的 **[日志] (Logs)** 标签页查看实时详细输出。")

    bot.launch(server_name="0.0.0.0", server_port=7860, prevent_thread_lock=True)
