...
【使用心得】
1、建议尾盘14:45 ~ 14:50 执行查询，免得接近尾声突然跳水失效
2、分数越大优先考虑
   BB[亮绿色值]越大优先考虑
...
📌 高收益样本：
        code        date  max_return  max_drawdown   win
922   600376  2025-09-04      152.98         -2.51  True
1065  600749  2025-07-21      128.14          5.55  True
1227  601606  2025-07-31      111.22         -6.78  True
132   000798  2025-11-11       95.99         -0.94  True
513   002513  2025-09-22       95.22         -2.22  True
489   002451  2025-11-04       94.99         10.01  True
68    000592  2025-10-20       90.93         -9.07  True
328   002148  2025-08-04       84.72          5.01  True
365   002208  2025-09-26       82.75         -4.76  True
362   002207  2025-06-11       81.74          2.14  True
============================================================
"""
import os
import sys
...
async def batch_scan_manager_async(target_codes, df_spot):
    ...
    interval = CONFIG.get("BATCH_INTERVAL_SEC", 3)
